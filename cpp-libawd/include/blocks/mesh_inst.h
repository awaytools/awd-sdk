...
namespace AWD
{
	...
	{	
		...
		/** \class Mesh
		*	\brief Descripes a AWDBlock for [Away3D Mesh](http://www.away3d.com)  as defined by AWDSpecs: \ref awd_pt2_12_4
		*
		*/
		class Mesh:
			public BASE::SceneBlockBase
		{
			...
			public:
				Mesh(std::string&, BASE::AWDBlock *);
				Mesh(std::string&, BASE::AWDBlock *, TYPES::F64 *);
				Mesh();
				~Mesh();
				
				/**
				*\brief Clear the list of Material for this Mesh. Should only be called from #GEOM::ProcessGeometry().
				*/
				void clear_final_materials();

				/**
				*\brief Add a Material to this Mesh. Should only be called from #GEOM::ProcessGeometry().
				...
				*/
				...
				/**
				*\brief Get the Material that should be used as default Material for this Mesh.
				*
				...
				*@return geom BASE::AWDBlock Pointer to the Material, that should be used as default Material for this Mesh.
				*/
				BASE::AWDBlock * get_defaultMat();

				/**
				*\brief Set the Material that should be used as default Material for this Mesh.
				*
				*If no material is set as DefaultMaterial, the lib will look for the first material set in the material-map.
				*If no material is set to the material-map, the default-material set for the AWDFile will be used.
				*@param[in] default_mat BASE::AWDBlock Pointer to the Material to use as default Material for this Mesh.
				*/
				void set_defaultMat(BASE::AWDBlock * default_mat);

				
				/**
				*\brief Get a Geometry for this Mesh.
				*@return geom BASE::AWDBlock Pointer to the Geometry to set.
				*/
				BASE::AWDBlock * get_geom();
				
				/**
				*\brief Set a Geometry for this Mesh. Should only be called from #GEOM::ProcessGeometry().
