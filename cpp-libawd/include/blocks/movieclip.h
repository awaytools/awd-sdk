#ifndef _LIBAWD_MOVIECLIP_H
#define _LIBAWD_MOVIECLIP_H
	...
	namespace BLOCKS
	{
			...
			public BASE::AWDBlock
		{
			private:
				...
				std::map<TYPES::UINT32, bool> mask_depths;
				std::map<TYPES::UINT32, bool> masked_depths;
			...
			public:
				MovieClip(const std::string& name);
				MovieClip();
				~MovieClip();
				...
				ANIM::mask_type get_mask_for_depth(TYPES::UINT32);
				void add_depth_for_mask(TYPES::UINT32);
				void add_depth_for_masked(TYPES::UINT32);
